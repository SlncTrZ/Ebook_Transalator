...
export function GlossaryEditor({ bookId }: GlossaryEditorProps) {
  ...
  if (!bookId) {
    return (
      <div className="glossary-editor">
        <h2>📝 Glossary</h2>
        <p className="muted">Select a book from the Library tab to manage its glossary.</p>
      </div>
    );
  }
  ...
  return (
    <div className="glossary-editor">
      <h2>📝 Glossary</h2>
      <p className="muted">Book ID: {bookId} — Add term mappings for consistent translations.</p>
